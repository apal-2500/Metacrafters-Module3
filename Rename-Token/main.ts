...
async function main() {
    ...
    const myKeypair = loadWalletKey('C:/Users/apal/.config/solana/devnet.json');   
    const mint = new web3.PublicKey("2AQsdYdapWtS3MMYN9BhxZzZYjwTseLpGbsPDRbkJgeq"); // place splToken address here
